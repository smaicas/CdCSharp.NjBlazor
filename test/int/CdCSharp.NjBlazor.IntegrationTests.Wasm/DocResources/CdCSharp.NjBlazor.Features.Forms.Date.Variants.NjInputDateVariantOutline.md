# NjInputDateVariantOutline

*Namespace:* CdCSharp.NjBlazor.Features.Forms.Date.Variants
*Assembly:* CdCSharp.NjBlazor
*Source:* Features_Forms_Date_Variants_NjInputDateVariantOutline_razor.g.cs
...
**Property:** `_partialValidations` (Protected)
...
**Property:** `CurrentValueAsStringWrapper` (Protected)
*Property Type:* `String`
*Nullable:* True
*Attributes:* 
...
**Method:** `OnStringValueChanged`
*Method Signature:* `Task OnStringValueChanged(String stringValue)`
