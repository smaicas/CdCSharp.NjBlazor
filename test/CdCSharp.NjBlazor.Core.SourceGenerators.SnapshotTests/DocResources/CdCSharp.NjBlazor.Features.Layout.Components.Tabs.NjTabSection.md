...
**Property:** `Parent` (Public)
    ...
    Gets or sets the parent NjTabs component for cascading parameters.
    

*Property Type:* `NjTabs`
*Nullable:* False
...
*Method Signature:* `Void OnParametersSet()`
    ...
    This method is called when the parameters are set. It adds the current section to its parent.
