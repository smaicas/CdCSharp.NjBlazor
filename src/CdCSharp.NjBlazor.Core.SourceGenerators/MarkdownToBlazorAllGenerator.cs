...
public class MarkdownToBlazorAllGenerator : IIncrementalGenerator
{
    ...
    /// <summary>
    /// Executes the generation logic for each class with the MarkdownResourcesAllAttribute and corresponding markdown files.
    /// </summary>
    ...
    /// </summary>
    /// <param name="namespaceName">The namespace of the original class.</param>
    ...
    /// </summary>
    /// <param name="resourceName">The resource file path.</param>
