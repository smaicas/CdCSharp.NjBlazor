...
//    {
//        // Registrar un proveedor incremental de clases con el atributo ComponentDeMuxAttribute
...
//        // Combinar la compilación con las clases seleccionadas
...
//        // Registrar la salida solo si el marcador existe
//        context.RegisterSourceOutput(compilationAndClasses, (spc, source) =>
//        {
//            // Verificar si el marcador existe antes de continuar
//            if (!IsFeatureMarkerGenerated(source.Left))
//            {
//                spc.ReportDiagnostic(Diagnostic.Create(
//                    new DiagnosticDescriptor(
//                        id: "DEMUX001",
//                        title: "Dependency Error",
//                        messageFormat: "The ComponentFeaturesMarker was not generated.",
//                        category: "ComponentDeMuxGenerator",
...
//            // Ejecutar la generación si el marcador está presente
//            Execute(source.Left, source.Right, spc);
//        });
//    }

//    private bool IsFeatureMarkerGenerated(Compilation compilation)
//    {
//        // Buscar la clase estática Marker en el espacio de nombres ComponentFeaturesGenerated
//        INamedTypeSymbol? markerSymbol = compilation.GetTypeByMetadataName("ComponentFeaturesGenerated.Marker");
//        return markerSymbol != null;
//    }
...
//        try
//        {
//            HashSet<string> processedClasses = []; // Para evitar duplicados
...
//                context.AddSource($"{className}.CDM.g.cs", SourceText.From(partialClassCode, Encoding.UTF8));
//            }
//        }
//        catch (Exception ex)
//        {
