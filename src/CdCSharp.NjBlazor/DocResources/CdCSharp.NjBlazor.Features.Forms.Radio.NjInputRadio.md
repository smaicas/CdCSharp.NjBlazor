...
*Source:* NjInputRadio.cs



    Represents a radio button input element. Inherits properties and behavior from the base
    NjInputRadioBase class. De-multiplexer for NjInputRadioVariant
    
---

**Property:** `Variant` (Public)
*Property Type:* `NjInputRadioVariant`
*Default:* `NjInputRadioVariant.Classic`
*Nullable:* False
...
---
## Inherited from NjInputRadioBase
