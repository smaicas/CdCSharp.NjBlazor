...
*Source:* NjInputCheckbox.cs



    Represents a custom input checkbox control that extends the functionality of the base input
    checkbox. De-multiplexer for NjInputCheckboxVariant
    
---

**Property:** `Variant` (Public)
*Property Type:* `NjInputCheckboxVariant`
*Default:* `NjInputCheckboxVariant.Classic`
*Nullable:* False
...
---
## Inherited from NjInputCheckboxBase
...
*Property Type:* `NjInputCheckboxSize`
*Default:* `NjInputCheckboxSize.Medium`
*Nullable:* False
*Attributes:* [ParameterAttribute]


**Property:** `TriState` (Public)
...
**Method:** `CalculateIcon`
*Method Signature:* `String CalculateIcon()`
...
**Method:** `CalculateIconSize`
*Method Signature:* `NjSvgIconSize CalculateIconSize()`
...
**Method:** `OnCheckboxChangedAsync`
*Method Signature:* `Task OnCheckboxChangedAsync()`
