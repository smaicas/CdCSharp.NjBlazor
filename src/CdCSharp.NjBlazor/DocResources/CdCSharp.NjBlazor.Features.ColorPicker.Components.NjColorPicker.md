...
**Property:** `OutputFormat` (Public)


    Gets or sets the output format for the color picker.
    

*Property Type:* `ColorpickerOutputFormat`
*Default:* `ColorpickerOutputFormat.RGB`
*Nullable:* False
*Attributes:* [ParameterAttribute]


**Property:** `PickedColor` (Public)
...
**Property:** `PickedColorChanged` (Public)
...
**Property:** `SelectionHeight` (Public)
...
**Property:** `SelectionWidth` (Public)
...
**Property:** `ThrottleMilliseconds` (Public)
