...
*Namespace:* CdCSharp.NjBlazor.Features.Controls.Components.Meter.Variants
*Assembly:* CdCSharp.NjBlazor
*Source:* Features_Controls_Components_Meter_Variants_NjMeterVariantFlat_razor.g.cs
