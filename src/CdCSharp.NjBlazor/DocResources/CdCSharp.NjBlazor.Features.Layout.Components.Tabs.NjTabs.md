...
**Property:** `ContentPadding` (Public)
...
**Property:** `HeaderPosition` (Public)


    Gets or sets the position of the header in the NjTabs component.
    

*Property Type:* `NjTabsHeaderPosition`
*Default:* `NjTabsHeaderPosition.Top`
*Nullable:* False
*Attributes:* [ParameterAttribute]


**Method:** `AddSection`
*Method Signature:* `Void AddSection(NjTabSection tabSection)`
