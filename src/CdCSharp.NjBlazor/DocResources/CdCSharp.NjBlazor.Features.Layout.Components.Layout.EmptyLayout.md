...
---
## Inherited from LayoutComponentBase

**Summary:**

            Optional base class for components that represent a layout.
            Alternatively, components may implement [T:Microsoft.AspNetCore.Components.IComponent] directly
            and declare their own parameter named [P:Microsoft.AspNetCore.Components.LayoutComponentBase.Body].
