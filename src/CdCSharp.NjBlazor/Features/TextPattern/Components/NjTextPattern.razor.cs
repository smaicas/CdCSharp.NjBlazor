...
public partial class NjTextPattern : NjComponentBase, ITextPatternJsCallback
{
    ...
    /// <summary>Gets or sets the TextPatternJsInterop for interacting with text patterns.</summary>
    /// <value>The TextPatternJsInterop instance.</value>
    [Inject]
    ITextPatternJsInterop TextPatternJs { get; set; } = default!;
    ...
    /// <summary>Gets or sets the event callback for text changes.</summary>
    /// <value>The event callback for text changes.</value>
    [Parameter]
    public EventCallback<string> TextChanged { get; set; }

    /// <summary>Gets or sets the default text value.</summary>
    /// <value>The default text value.</value>
    [Parameter]
    [EditorRequired]
    public string DefaultText { get; set; } = string.Empty;

    /// <summary>Gets or sets the format of the data.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether date formats are allowed.</summary>
    /// <value>True if date formats are allowed; otherwise, false.</value>
    [Parameter]
    public bool AllowDateFormats { get; set; } = false;

    /// <summary>Gets or sets a value indicating whether the content is editable.</summary>
    /// <value>True if the content is editable; otherwise, false.</value>
    [Parameter]
    ...
    /// <summary>Determines whether the control should be rendered based on changes in text or format.</summary>
    /// <returns>True if the control should be rendered; otherwise, false.</returns>
