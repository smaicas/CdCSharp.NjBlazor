...
internal static partial class DetectionExtensions
{
    ...
    /// </summary>
    /// <param name="line">The string to check for block quote formatting.</param>
    /// <returns>True if the string represents a block quote; otherwise, false.</returns>
    internal static bool IsBlockQuote(this string line) => line.TrimStart().StartsWith("> ");

    /// <summary>Checks if a given string represents a code block.</summary>
    /// <param name="line">The string to check.</param>
    /// <returns>True if the string represents a code block, false otherwise.</returns>
    internal static bool IsCodeBlock(this string line) => line.TrimStart().StartsWith("```");

    /// <summary>Checks if a given string represents a header.</summary>
    /// <param name="line">The string to be checked.</param>
    /// <returns>True if the string represents a header, false otherwise.</returns>
    ...
    /// </summary>
    /// <param name="line">The string to check.</param>
    /// <returns>True if the string represents a line separator, false otherwise.</returns>
    internal static bool IsLineSeparator(this string line) => line.Trim().Equals("***") || line.Trim().Equals("---") || line.Trim().Equals("___");

    /// <summary>Checks if a string represents a paragraph.</summary>
    /// <param name="line">The string to check.</param>
    /// <returns>True if the string represents a paragraph, false otherwise.</returns>
    ...
    /// <summary>Checks if a string represents an unordered list item.</summary>
    /// <param name="line">The string to check.</param>
    /// <returns>True if the string represents an unordered list item, false otherwise.</returns>
