...
public partial class NjCodeHighlight : NjComponentBase
{
    ...
    /// <summary>Gets or sets the child content to be rendered.</summary>
    /// <remarks>
    /// If the 'Code' property is not null, the content will be highlighted using the specified language.
    /// </remarks>
    /// <value>The child content to be rendered.</value>
    [Parameter]
    ...
    /// <summary>Gets or sets the code parameter.</summary>
