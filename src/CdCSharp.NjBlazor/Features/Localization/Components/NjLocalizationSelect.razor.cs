...
{
    /// <summary>Gets or sets the ILocalizationJsInterop for handling JavaScript interop related to localization.</summary>
    [Inject] ILocalizationJsInterop LocalizationJs { get; set; } = default!;

    /// <summary>Gets or sets the NavigationManager for navigating between pages.</summary>
    [Inject] NavigationManager Navigation { get; set; } = default!;

    /// <summary>Injects the LocalizationSettings options.</summary>
    /// <remarks>
    /// This attribute is used to inject an instance of the LocalizationSettings options
    /// into the property named LocalizationSettings.
    /// </remarks>
    [Inject] IOptions<LocalizationSettings> LocalizationSettings { get; set; }

    /// <summary>Gets or sets the path to the icon file.</summary>
    /// <value>The path to the icon file.</value>
    [Parameter]
    public string? OnlyIcon { get; set; }

    /// <summary>Gets or sets the size of the icon.</summary>
    /// <value>The size of the icon.</value>
    [Parameter]
    public NjSvgIconSize OnlyIconSize { get; set; }

    /// <summary>Gets or sets the position of the dropdown options.</summary>
    /// <value>The position of the dropdown options.</value>
    [Parameter]
    ...
    /// <exception cref="ArgumentNullException">Thrown when setting a null culture.</exception>
