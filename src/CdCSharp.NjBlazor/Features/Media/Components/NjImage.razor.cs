...
/// <summary>
/// Represents an image component in the Nj framework.
/// Inherits functionality from the NjComponentBase class.
/// </summary>
public partial class NjImage : NjComponentBase
{
    /// <summary>Gets or sets the source of an element.</summary>
    /// <value>The source of the element.</value>
    [Parameter]
    ...
    /// <summary>Gets or sets the alignment mode for the element along the cross axis.</summary>
    /// <value>The alignment mode for the element along the cross axis.</value>
    [Parameter]
