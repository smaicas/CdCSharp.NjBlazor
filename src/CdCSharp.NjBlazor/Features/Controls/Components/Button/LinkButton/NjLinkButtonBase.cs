...
public abstract class NjLinkButtonBase : NjControlComponentBase
{
    ...
    /// </summary>
    /// <value>
    /// The color for the post-adornment.
    /// </value>
    [Parameter]
    ...
    /// </summary>
    /// <value>
    /// The target for the link button.
    /// </value>
    [Parameter]
    ...
    /// </summary>
    /// <value>
    /// The function that transforms the input string.
    /// </value>
    /// <remarks>
    /// The default transformation function converts the input string to uppercase.
    /// </remarks>
    [Parameter]
    ...
    /// </summary>
    /// <value>
    /// The CSS class if focused; otherwise, an empty string.
    /// </value>
    ...
    /// Thrown when the target type is not recognized.
    /// </exception>
