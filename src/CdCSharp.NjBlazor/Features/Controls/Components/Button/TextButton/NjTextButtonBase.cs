...
public abstract class NjTextButtonBase : NjControlComponentBase
{
    ...
    /// <value>The function that transforms text.</value>
    /// <remarks>The default transformation function converts text to uppercase.</remarks>
    [Parameter]
    ...
    /// <value>The inline style as a string.</value>
