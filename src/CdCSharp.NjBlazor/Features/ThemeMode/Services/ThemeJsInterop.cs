    ...
    : ModuleJsInterop(jsRuntime, CSharpReferences.Modules.ThemeJs), IThemeJsInterop
{
    ...
    /// </summary>
    /// <returns>
    /// A <see cref="ValueTask{TResult}" /> representing the task result, where true indicates dark
    /// mode and false indicates light mode.
    /// </returns>
    ...
    /// A boolean value indicating whether to set dark mode.
    /// </param>
    /// <returns>
    /// A <see cref="ValueTask" /> representing the asynchronous operation.
    /// </returns>
    ...
    /// indicating the success of toggling dark mode.
    /// </returns>
