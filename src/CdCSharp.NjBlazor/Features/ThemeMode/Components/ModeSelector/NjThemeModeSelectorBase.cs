...
public abstract class NjThemeModeSelectorBase : NjComponentBase
{
    ...
    /// <summary>Gets the CSS class for dark mode based on the IsDarkMode property.</summary>
    /// <value>The CSS class for dark mode if IsDarkMode is true; otherwise, an empty string.</value>
    protected string DarkClass => IsDarkMode ? "darkMode" : "";

    /// <summary>Indicates whether the application is in dark mode.</summary>
    ...
    /// <exception cref="ArgumentNullException">Thrown when the ThemeJs object is null.</exception>
