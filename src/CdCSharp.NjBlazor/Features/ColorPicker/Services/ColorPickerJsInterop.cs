        ...
        IColorPickerJsInterop
{
    ...
    /// </summary>
    /// <param name="canvas">A reference to the canvas element.</param>
    /// <param name="element">A reference to the element whose position needs to be refreshed.</param>
    /// <param name="clientX">The client's X-coordinate.</param>
    /// <param name="clientY">The client's Y-coordinate.</param>
    ...
    /// <param name="clientX">The clientX coordinate.</param>
    /// <param name="clientY">The clientY coordinate.</param>
    /// <returns>An array of doubles representing the removed relative bound position.</returns>
