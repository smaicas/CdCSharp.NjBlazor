...
/// <summary>
/// Represents a color picker component that is based on the NjComponentBase class. This class
/// provides functionality for selecting colors.
/// </summary>
public partial class NjColorPicker : NjComponentBase
{
    ...
    private ElementReference handlerSelectionReference;

    private ElementReference selectionReference;

    private bool shouldRender;

    private Action<MouseEventArgs>? ThrottleDragSelection;

    /// <summary>
    /// Gets or sets the event callback for cancel action.
    /// </summary>
    /// <value>
    /// The event callback for cancel action.
    /// </value>
    [Parameter]
    ...
    /// <summary>
    /// Gets or sets the output format for the color picker.
    /// </summary>
    /// <value>
    /// The output format for the color picker.
    /// </value>
    [Parameter]
    ...
    /// <summary>
    /// Gets or sets the event callback for when the picked color changes.
    /// </summary>
    /// <value>
    /// The event callback for the picked color change.
    /// </value>
    [Parameter]
    ...
    /// </summary>
    /// <value>
    /// The width of the selection. The default value is 200.
    /// </value>
    [Parameter]
    public int SelectionWidth { get; set; } = 200;

    /// <summary>
    /// Gets or sets the throttle time in milliseconds.
    /// </summary>
    /// <value>
    ...
    /// <summary>
    /// Gets or sets the ColorPickerJsInterop instance for color picking functionality.
    /// </summary>
    /// <value>
    /// The ColorPickerJsInterop instance for color picking functionality.
    /// </value>
    [Inject]
    private IColorPickerJsInterop ColorPickerJs { get; set; } = default!;
    ...
    /// <summary>
    /// This method is called when the component's parameters are set. It checks if rendering is
    /// required based on changes in the picked color or HSV color.
    /// </summary>
    /// <remarks>
    /// The method compares the current picked color and HSV color with the previous values to
    ...
    /// </summary>
    /// <returns>
    /// True if rendering should occur, false otherwise.
    /// </returns>
