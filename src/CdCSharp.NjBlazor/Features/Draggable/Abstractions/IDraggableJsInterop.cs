...
public interface IDraggableJsInterop
{
    ...
    /// </summary>
    /// <param name="element">The reference to the HTML element on which to enable mouse move events.</param>
    /// <param name="dotnetObjectReference">A reference to a .NET object that will handle the mouse move events.</param>
    ...
    /// </summary>
    /// <param name="element">The reference to the element for which the mouse move event needs to be disabled.</param>
    /// <returns>A <see cref="ValueTask"/> representing the asynchronous operation.</returns>
