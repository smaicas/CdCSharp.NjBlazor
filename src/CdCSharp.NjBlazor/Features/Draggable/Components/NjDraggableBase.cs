...
/// </summary>
/// <remarks>
/// This class serves as a base for components that can be dragged within the Nj framework.
/// It extends the NjComponentBase class and implements the INjDraggableJsCallbacks interface.
/// </remarks>
public abstract class NjDraggableBase : NjComponentBase, INjDraggableJsCallbacks
{
    /// <summary>Field to hold a reference to a JavaScript callbacks relay object.</summary>
    /// <value>The JavaScript callbacks relay object.</value>
    [DisallowNull]
    internal NjDraggableJsCallbackRelay? _jsCallbacksRelay;

    /// <summary>Reference to an element in the DOM.</summary>
    ...
    /// <summary>Gets or sets the event callback for mouse drag events.</summary>
    /// <value>The event callback for mouse drag events.</value>
    [Parameter]
    public EventCallback<MouseEventArgs> OnDrag { get; set; }

    /// <summary>Gets or sets the event callback for when a drag operation ends.</summary>
    /// <value>The event callback for when a drag operation ends.</value>
    [Parameter]
    public EventCallback<MouseEventArgs> OnDragEnds { get; set; }

    /// <summary>Gets or sets the event callback for handling the drag start event.</summary>
    /// <value>The event callback for handling the drag start event.</value>
    [Parameter]
    public EventCallback<MouseEventArgs> OnDragStart { get; set; }

    /// <summary>Gets or sets the callback for the mouse leave event.</summary>
    /// <value>The callback for the mouse leave event.</value>
    [Parameter]
    public EventCallback<MouseEventArgs> OnMouseLeave { get; set; }

    /// <summary>Gets or sets the DraggableJsInterop service for enabling drag-and-drop functionality.</summary>
    /// <value>The DraggableJsInterop service.</value>
    [Inject]
    ...
    /// </summary>
    /// <param name="args">The MouseEventArgs containing information about the mouse event.</param>
