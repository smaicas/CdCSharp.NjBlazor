        ...
        IDraggableJsInterop
{
    ...
    /// </summary>
    /// <param name="element">The reference to the element for which mouse move functionality is enabled.</param>
    /// <param name="dotnetObjectReference">The reference to the .NET object associated with the element.</param>
    ...
    /// <summary>Disables mouse move events for a specified HTML element asynchronously.</summary>
    /// <param name="element">The reference to the HTML element for which mouse move events should be disabled.</param>
    /// <returns>A <see cref="ValueTask"/> representing the asynchronous operation.</returns>
