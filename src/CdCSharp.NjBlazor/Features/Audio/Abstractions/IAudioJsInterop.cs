...
public interface IAudioJsInterop
{
    ...
    /// </summary>
    /// <param name="elRef">
    /// The reference to the element for which the audio source needs to be set.
    /// </param>
    /// <returns>
    /// A <see cref="ValueTask{TResult}" /> representing the asynchronous operation, with the result
    /// being the audio source as a string.
    /// </returns>
    ValueTask<string> SetAudioSourceAsync(ElementReference elRef);

    /// <summary>
    /// Starts an asynchronous operation to begin recording.
    /// </summary>
    /// <returns>
    ...
    /// </summary>
    /// <param name="canvasElementReference">
    /// A reference to the canvas element to visualize.
    /// </param>
    /// <returns>
    /// A ValueTask representing the asynchronous operation that yields the visualization as a string.
    /// </returns>
