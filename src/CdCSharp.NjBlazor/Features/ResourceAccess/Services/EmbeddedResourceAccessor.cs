...
public class EmbeddedResourceAccessor : IEmbeddedResourceAccessor
{
    ...
    /// <summary>Initializes a new instance of the EmbeddedResourceAccessor class.</summary>
    /// <param name="cacheService">The cache service to use for accessing embedded resources.</param>
    /// <exception cref="ArgumentNullException">Thrown when the cache service is null.</exception>
    ...
    /// <param name="encoding">The encoding to be used for reading the file (default is UTF-8).</param>
    /// <returns>A task that represents the asynchronous operation. The task result contains the content of the resource file as a string.</returns>
    /// <exception cref="ApplicationException">Thrown when the entry assembly is not found.</exception>
    /// <exception cref="ArgumentException">Thrown when the specified resource file is not found.</exception>
