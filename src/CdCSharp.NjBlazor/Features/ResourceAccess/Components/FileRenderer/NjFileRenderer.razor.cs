...
{
    [Inject] ICacheService<NjFileRenderer, RenderFragment> RenderFragmentCache { get; set; } = default!;
    [Inject] IEmbeddedResourceAccessor EmbeddedResourceAccessor { get; set; } = default!;
    [Inject] IStringLocalizer<NjFileRenderer> Loc { get; set; } = default!;
    [Inject] IDOMJsInterop DomJs { get; set; } = default!;
