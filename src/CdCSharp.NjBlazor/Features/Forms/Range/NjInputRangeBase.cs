...
public abstract class NjInputRangeBase : NjInputBase<double>
{
    ...
    /// A boolean value indicating whether this is the first render of the component.
    /// </param>
    /// <remarks>
    /// This method is called after the component has been rendered. If it is the first render and
    /// the InputReference is not null, the _inputReferenceId is set to the Id of the InputReference
    /// and the component's state is refreshed.
    /// </remarks>
    ...
    /// </param>
    /// <param name="result">
    /// When this method returns, contains the double value equivalent of the string, if the
    /// conversion succeeded, or zero if the conversion failed.
    /// </param>
    /// <param name="validationErrorMessage">
    /// When this method returns, contains any validation error message.
    /// </param>
    /// <returns>
