...
/// </summary>
/// <typeparam name="string">The type of input handled by this class.</typeparam>
public abstract class NjInputTextBase : NjInputBase<string>
{
    ...
    /// <value>True if the input is a password; otherwise, false.</value>
    [Parameter]
    public bool IsPassword { get; set; }

    /// <summary>Gets or sets a value indicating whether the input is a text area.</summary>
    /// <value>True if the input is a text area; otherwise, false.</value>
    [Parameter]
    ...
    /// <returns>True if the current value is empty; otherwise, false.</returns>
    protected override bool IsEmpty => string.IsNullOrEmpty(CurrentValue);

    /// <summary>Determines the CSS class for the password field based on the IsPassword property.</summary>
    /// <value>The CSS class for the password field.</value>
    ...
    /// </summary>
    /// <value>
    /// If IsTextArea is true, returns the CSS class reference for text area styling; otherwise, returns an empty string.
    /// </value>
    ...
    /// </summary>
    /// <param name="changeEventArgs">The event arguments containing the changed value.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
