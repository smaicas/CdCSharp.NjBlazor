...
/// </summary>
/// <typeparam name="System.Drawing.Color">The type of color being handled.</typeparam>
public abstract class NjInputColorBase : NjInputBase<System.Drawing.Color>
{
    /// <summary>
    /// This method is called when parameters are set. 
    /// If the current value is the default value, it is set to the color red.
    /// </summary>
    ...
    /// <summary>Indicates whether a specific operation is open or not.</summary>
    ...
    /// <summary>Accepts the picker selection.</summary>
