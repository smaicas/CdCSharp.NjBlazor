...
/// </summary>
/// <remarks>
/// This class is internal and sealed, meaning it cannot be inherited from and is only accessible within the assembly.
/// Implements the IDisposable interface to allow proper resource cleanup.
/// </remarks>
internal sealed class NjInputFileJsCallbacksRelay : IDisposable
{
    private readonly INjInputFileJsCallbacks _callbacks;

    /// <summary>Initializes a new instance of the NjInputFileJsCallbacksRelay class.</summary>
    /// <param name="callbacks">The callbacks interface for input file operations.</param>
    ...
    /// </summary>
    /// <param name="files">An array of NjBrowserFile objects representing the changed files.</param>
