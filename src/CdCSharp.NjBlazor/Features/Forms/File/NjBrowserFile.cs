...
internal sealed class NjBrowserFile : IBrowserFile
{
    ...
    /// <summary>Gets or sets the date and time when the object was last modified.</summary>
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown when the provided size is negative.</exception>
    public long Size
    {
        get => _size;
        set
    ...
    /// <summary>Gets or sets the owner of the input file.</summary>
    internal NjInputFileBase Owner { get; set; }

    /// <summary>
    /// Opens a read stream for the file.
    /// </summary>
    /// <param name="maxAllowedSize">The maximum allowed size for the file (default is 512000 bytes).</param>
    /// <param name="cancellationToken">A cancellation token to cancel the operation (default is none).</param>
    /// <returns>A stream for reading the file.</returns>
    /// <exception cref="IOException">Thrown when the file size exceeds the maximum allowed size.</exception>
