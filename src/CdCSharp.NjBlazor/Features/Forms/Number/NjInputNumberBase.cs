...
/// </summary>
/// <typeparam name="double?">The type of numeric value handled by the input component.</typeparam>
public abstract class NjInputNumberBase : NjInputBase<double?>
{
    ...
    /// <value>True if arrows should be shown; otherwise, false.</value>
    [Parameter]
    ...
    /// <value>The title of the object.</value>
    [Parameter]
    ...
    /// <remarks>
    /// If the property ReadOnly is set to true, the method returns immediately without performing any operation.
    /// The method continuously decreases the current value by the specified step until the process is stopped.
    /// The delay between each decrease operation is gradually reduced by 50 milliseconds.
    /// </remarks>
    ...
    /// <remarks>
    /// If the property ReadOnly is set to true, the method returns immediately without performing any operation.
    /// The method continuously increases the current value by the specified step until the process is stopped.
    /// The delay between each decrease operation is gradually reduced by 50 milliseconds.
    /// </remarks>
    ...
    /// </summary>
    /// <param name="newValue">The new value to update the current value with.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    ...
    /// <param name="result">The parsed double value, if successful; otherwise, null.</param>
    /// <param name="validationErrorMessage">An error message if parsing fails; otherwise, an empty string.</param>
