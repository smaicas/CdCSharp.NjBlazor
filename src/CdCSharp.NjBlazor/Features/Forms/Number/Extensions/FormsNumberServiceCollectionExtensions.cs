...
/// <summary>Contains extension methods for configuring services.</summary>
public static class FormsNumberServiceCollectionExtensions
{
    ...
    /// </summary>
    /// <param name="services">The IServiceCollection to add the NjBlazorFormsNumber service to.</param>
