...
public abstract class NjInputCheckboxBase : NjInputBase<bool?>
{
    ...
    /// <summary>Gets or sets the content of the component.</summary>
    /// <remarks>This property allows rendering child content within the component.</remarks>
    [Parameter]
    public RenderFragment? ChildContent { get; set; }

    /// <summary>Gets or sets the size of the input checkbox.</summary>
    /// <value>The size of the input checkbox.</value>
    [Parameter]
    public NjInputCheckboxSize Size { get; set; } = NjInputCheckboxSize.Medium;

    /// <summary>Gets or sets a value indicating whether the control supports three states.</summary>
    /// <value>True if the control supports three states; otherwise, false.</value>
    [Parameter]
    ...
    /// </summary>
    /// <returns>The icon corresponding to the current value:
    ...
    /// <summary>Calculates the corresponding icon size based on the input checkbox size.</summary>
    /// <returns>The calculated icon size based on the input checkbox size.</returns>
    ...
    /// <remarks>
    /// If it is the first render, the method checks if the InputReference is not null and assigns the Id to _inputReferenceId.
    /// If TriState is false and CurrentValue is null, CurrentValue is set to false.
    /// Finally, the method calls StateHasChanged to notify the component that its state has changed.
    /// </remarks>
    ...
    /// <summary>Handles the asynchronous event when a checkbox is changed.</summary>
