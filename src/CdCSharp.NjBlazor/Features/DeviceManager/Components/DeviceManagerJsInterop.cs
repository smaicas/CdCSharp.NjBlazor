        ...
        IDeviceManagerJsInterop
{
    ...
    /// </summary>
    /// <returns>The width of the window as an integer.</returns>
    ...
    /// <returns>The retrieved value based on the device's width.</returns>
    /// <exception cref="InvalidOperationException">Thrown when the module task is not loaded.</exception>
    ...
    /// <returns>The retrieved value based on the width of the device.</returns>
    /// <exception cref="InvalidOperationException">Thrown when the module task is not loaded.</exception>
    public async ValueTask<TValue?> GetByWidth<TValue>(
        TValue? valueMobile,
        TValue? valueTablet = null,
    ...
    /// </summary>
    /// <param name="dotnetReference">The dotnet reference to associate with the callback.</param>
