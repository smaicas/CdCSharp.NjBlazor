...
public interface IAntiforgeryHttpClientFactory
{
    ...
    /// The name of the HttpClient instance to create (default is "authorizedClient").
    /// </param>
    /// <returns>
    /// A task representing the asynchronous operation that returns the created HttpClient instance.
    /// </returns>
