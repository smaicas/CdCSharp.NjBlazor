...
public class AntiforgeryHttpClientFactory : IAntiforgeryHttpClientFactory
{
    ...
    /// The HTTP client factory to create HTTP clients.
    /// </param>
    /// <param name="njJs">
    /// The Antiforgery JavaScript interop service.
    /// </param>
    /// <exception cref="ArgumentNullException">
    /// Thrown when httpClientFactory or njJs is null.
    /// </exception>
    ...
    /// The name of the HttpClient to create (default is "authorizedClient").
    /// </param>
    /// <returns>
    /// An HttpClient configured with the anti-forgery token in the request headers.
    /// </returns>
    /// <exception cref="Exception">
    /// Thrown when there is an issue retrieving the anti-forgery token.
    /// </exception>
