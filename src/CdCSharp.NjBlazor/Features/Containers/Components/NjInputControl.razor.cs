...
public partial class NjInputControl : NjComponentBase
{
    ...
    /// <summary>Gets the CSS class for the form control.</summary>
    /// <value>The CSS class for the form control.</value>
    ...
    /// </summary>
    /// <value>
    /// The CSS class for the disabled state. Returns "Disabled" if the component is disabled; otherwise, returns an empty string.
    /// </value>
