...
public static class LayoutServiceCollectionExtensions
{
    ...
    /// </summary>
    /// <param name="services">
    /// The IServiceCollection to add the NjBlazorLayout to.
    /// </param>
    /// <param name="lifetime">
    ...
    public static void AddNjBlazorLayout(
        ...
        ServiceLifetime lifetime = ServiceLifetime.Transient) => settings ??= new NjLayoutSettings();//services.AddNjBlazorCssInclude(settings.CssIncludeSettings, nameof(Nj.Blazor.Layout), lifetime: lifetime);
}