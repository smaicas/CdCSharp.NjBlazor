...
{
    /// <summary>Gets or sets the direction of the flex container.</summary>
    /// <value>The direction of the flex container.</value>
    [Parameter]
    public FlexDirectionMode Direction { get; set; } = FlexDirectionMode.Row;

    /// <summary>Gets or sets the value for growth.</summary>
    /// <value>The value for growth.</value>
    [Parameter]
    public int Grow { get; set; }

    /// <summary>Gets or sets a value indicating whether the content should be displayed inline.</summary>
    /// <value>True if the content should be displayed inline; otherwise, false.</value>
    [Parameter]
    public bool Inline { get; set; }

    /// <summary>Gets or sets the spacing value.</summary>
    /// <value>The spacing value.</value>
    [Parameter]
    public int Spacing { get; set; }

    /// <summary>Gets or sets the mode for justifying content within a container.</summary>
    /// <value>The mode for justifying content. Default value is JustifyContentMode.FlexStart.</value>
    [Parameter]
    public JustifyContentMode JustifyContent { get; set; } = JustifyContentMode.FlexStart;

    /// <summary>Gets or sets the alignment mode for the items along the cross axis.</summary>
    /// <value>The alignment mode for the items along the cross axis.</value>
    [Parameter]
