# NjInputTextVariantOutline

*Namespace:* CdCSharp.NjBlazor.Features.Forms.Text.Variants
*Assembly:* CdCSharp.NjBlazor
*Source:* Features_Forms_Text_Variants_NjInputTextVariantOutline_razor.g.cs
...
---
## Inherited from NjInputTextBase
...
**Property:** `PasswordClass` (Protected)
...
**Property:** `TextAreaClass` (Protected)
...
*Method Signature:* `Task UpdateCurrentValue(String newValue)`
