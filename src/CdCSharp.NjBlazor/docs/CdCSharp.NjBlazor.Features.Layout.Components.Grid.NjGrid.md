...
**Property:** `TemplateColumns` (Public)

Gets or sets the template columns mode.

*Property Type:* `TemplateColumnsMode`
*Default:* `TemplateColumnsMode.Fit`
*Nullable:* False
*Attributes:* [ParameterAttribute]


**Property:** `TemplateColumnsSpecific` (Public)
...
**Property:** `JustifyItems` (Public)

Gets or sets the mode for justifying items within a container.

*Property Type:* `JustifyItemsMode`
*Default:* `JustifyItemsMode.Normal`
*Nullable:* False
*Attributes:* [ParameterAttribute]
...
*Default:* `AlignItemsMode.Center`
*Nullable:* False
*Attributes:* [ParameterAttribute]


**Method:** `AddCell`
*Method Signature:* `Void AddCell(NjGridCell gridCell)`
