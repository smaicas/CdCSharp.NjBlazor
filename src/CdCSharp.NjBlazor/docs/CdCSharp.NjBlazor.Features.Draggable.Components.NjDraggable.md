...
*Source:* NjDraggable.razor.cs



    Represents a draggable control that extends the functionality of the base draggable control.
...
---
## Inherited from NjDraggableBase
...
**Property:** `DraggableJs` (Protected)

Gets or sets the DraggableJsInterop service for enabling drag-and-drop functionality.

*Property Type:* `IDraggableJsInterop`
*Default:* `default!`
*Nullable:* False
*Attributes:* [InjectAttribute]


**Method:** `NotifyMouseMoveAsync`
*Method Signature:* `Task NotifyMouseMoveAsync(MouseEventArgs mouseEventArgs)`
...
**Method:** `BeginDrag`
*Method Signature:* `Task BeginDrag(MouseEventArgs args)`
...
**Method:** `Leave`
*Method Signature:* `Task Leave(MouseEventArgs args)`
...
**Method:** `StopDrag`
*Method Signature:* `Task StopDrag(MouseEventArgs args)`
