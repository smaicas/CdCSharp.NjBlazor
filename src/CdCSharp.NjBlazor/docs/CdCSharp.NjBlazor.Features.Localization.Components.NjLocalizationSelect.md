...
*Default:* `NjDropdownOptionsPosition.TopRight`
*Nullable:* False
*Attributes:* [ParameterAttribute]
...
**Property:** `CurrentCulture` (Public)


    Gets or sets the current culture used for localization.
    

*Property Type:* `CultureInfo`
*Nullable:* True
*Attributes:* 
