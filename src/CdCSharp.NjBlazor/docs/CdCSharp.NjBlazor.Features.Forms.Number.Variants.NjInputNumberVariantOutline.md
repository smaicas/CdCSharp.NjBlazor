# NjInputNumberVariantOutline

*Namespace:* CdCSharp.NjBlazor.Features.Forms.Number.Variants
*Assembly:* CdCSharp.NjBlazor
*Source:* Features_Forms_Number_Variants_NjInputNumberVariantOutline_razor.g.cs
...
---
## Inherited from NjInputNumberBase
...
*Property Type:* `String`
*Default:* `Media.Icons.NjIcons.Materials.MaterialIcons.i_arrow_circle_right`
*Nullable:* True
*Attributes:* [ParameterAttribute]
...
*Property Type:* `String`
*Default:* `Media.Icons.NjIcons.Materials.MaterialIcons.i_arrow_circle_left`
*Nullable:* True
*Attributes:* [ParameterAttribute]
...
**Method:** `DecreaseByStepAsync`
*Method Signature:* `Task DecreaseByStepAsync()`
...
**Method:** `IncreaseByStepAsync`
*Method Signature:* `Task IncreaseByStepAsync()`
...
*Method Signature:* `Task UpdateCurrentValue(Nullable newValue)`
...
**Method:** `StopDecreaseAsync`
*Method Signature:* `Task StopDecreaseAsync()`
...
**Method:** `StopIncreaseAsync`
*Method Signature:* `Task StopIncreaseAsync()`
...
*Method Signature:* `Boolean TryParseValueFromString(String value, Nullable result, String validationErrorMessage)`
...
*Method Signature:* `String FormatValueAsString(Nullable value)`
