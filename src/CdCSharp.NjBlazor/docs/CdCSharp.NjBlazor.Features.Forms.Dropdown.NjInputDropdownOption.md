# NjInputDropdownOption

*Namespace:* CdCSharp.NjBlazor.Features.Forms.Dropdown
*Assembly:* CdCSharp.NjBlazor
*Source:* NjInputDropdownOption.razor.cs
...
**Property:** `ParentDropdownOptions` (Public)
...
*Default:* `default!`
*Nullable:* False
*Attributes:* [ParameterAttribute], [EditorRequiredAttribute], [DisallowNullAttribute]
