...
**Property:** `ParentTree` (Public)

Gets or sets the parent NjTree in the cascading parameter.

*Property Type:* `NjTree`
*Default:* `default!`
*Nullable:* False
*Attributes:* [CascadingParameterAttribute]


**Property:** `ParentNode` (Public)

Gets or sets the parent node in a cascading parameter.

*Property Type:* `NjTreeNode`
*Nullable:* True
*Attributes:* [CascadingParameterAttribute]


**Property:** `ChildNodes` (Public)
...
**Method:** `AddChildNode`
*Method Signature:* `Void AddChildNode(NjTreeNode node)`
