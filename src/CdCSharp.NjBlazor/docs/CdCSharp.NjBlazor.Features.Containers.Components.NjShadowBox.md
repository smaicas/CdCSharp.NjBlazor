...
**Property:** `OffsetX` (Public)

Gets or sets the X offset value.
...
**Property:** `OffsetY` (Public)

Gets or sets the Y offset value.
...
**Property:** `BlurRadius` (Public)

Gets or sets the blur radius for an effect.
...
**Property:** `SpreadRadius` (Public)

Gets or sets the spread radius for a specific operation.
...
*Default:* `NjColors.Black.Default.SetAlpha(0.2)`
*Nullable:* False
*Attributes:* [ParameterAttribute]


**Property:** `Inset` (Public)
