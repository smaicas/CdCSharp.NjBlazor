...
*Source:* NjLinkButton.cs



    Represents a custom link button control that inherits from NjLinkButtonBase.
    De-multiplexer for NjLinkButtonVariant
    
---

**Property:** `Variant` (Public)
*Property Type:* `NjLinkButtonVariant`
*Default:* `NjLinkButtonVariant.Flat`
*Nullable:* False
