...
**Property:** `Direction` (Public)

Gets or sets the direction of the flex container.

*Property Type:* `FlexDirectionMode`
*Default:* `FlexDirectionMode.Row`
*Nullable:* False
*Attributes:* [ParameterAttribute]


**Property:** `Grow` (Public)
...
**Property:** `JustifyContent` (Public)

Gets or sets the mode for justifying content within a container.

*Property Type:* `JustifyContentMode`
*Default:* `JustifyContentMode.FlexStart`
*Nullable:* False
*Attributes:* [ParameterAttribute]


**Property:** `AlignItems` (Public)

Gets or sets the alignment mode for the items along the cross axis.

*Property Type:* `AlignItemsMode`
*Default:* `AlignItemsMode.Start`
*Nullable:* False
*Attributes:* [ParameterAttribute]


**Property:** `Wrap` (Public)


    Gets or sets the wrapping mode for flex items.
    

*Property Type:* `FlexWrapMode`
*Default:* `FlexWrapMode.Wrap`
*Nullable:* False
*Attributes:* [ParameterAttribute]
