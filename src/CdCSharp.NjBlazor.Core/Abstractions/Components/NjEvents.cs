...
public class NjEvents
{
    ...
    /// </summary>
    /// <typeparam name="T">The type of the argument for the action.</typeparam>
    /// <param name="action">The action to be debounced.</param>
    /// <param name="interval">The interval to wait before executing the action.</param>
    /// <returns>A debounced action that will execute the provided action with the specified interval.</returns>
    ...
    /// <param name="interval">The time interval to wait between invocations of the action.</param>
    /// <returns>A throttled action that can be invoked with an argument of type T.</returns>
