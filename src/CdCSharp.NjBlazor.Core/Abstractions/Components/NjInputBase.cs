...
public abstract class NjInputBase<TValue> : InputBase<TValue>
{
    ...
    /// </summary>
    /// <value>
    /// True if the current value is null, otherwise false.
    /// </value>
    ...
    /// </param>
    /// <returns>
    /// A single string containing non-empty classes separated by a specified delimiter.
    /// </returns>
    ...
    /// </param>
    /// <remarks>
    /// This method sets the InputReferenceId to the Id of the InputReference if it is not null and
    ...
    /// The event arguments for the input change.
    /// </param>
    /// <returns>
    ...
    /// Thrown to indicate that the method implementation is not provided.
    /// </exception>
